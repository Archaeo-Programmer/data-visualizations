...
var distinctDOY = col.filterDate('2020-01-01', '2025-01-01');
...
var legtext = text.draw(leglabel, pt2, legscale, {fontSize: 32, textColor: '000000', outlineColor: '000000', outlineWidth: 0.5});

// Define a white background image
...
var rgbVis = comp.map(function(img) {
  var scale = 10000
  var textVis = { fontSize: 32, textColor: '000000', outlineColor: '000000', outlineWidth: 0.5}
  var label = text.draw(img.get('system:index'), pt, scale, textVis)
  
    return whiteBackground // ✅ Add white background first
    .blend(img.visualize(visParams).unmask(1).clip(mask)) // ✅ Fill NoData with white
    .blend(label)
    .blend(gradientBar)
    .blend(legtext);
});
...
Export.video.toDrive({
  ...
  description: 'NDVI_Animation_2020-2025_white_bkgd',  // Name
  ...
  dimensions: 600,           // Output resolution
